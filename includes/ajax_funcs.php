<?php
	...
	// ========================================================================
		$n_LocusID = strtoupper(trim(mysqli_real_escape_string($whConn, $_REQUEST["lid"])));
	...
	// ========================================================================
		...
		$locusID = strtoupper(trim(mysqli_real_escape_string(isset($_REQUEST["term"]) ? $_REQUEST["term"] : '')));
	...
	// ========================================================================
		// Get static info
		$staticType = strtoupper(trim(mysqli_real_escape_string($whConn, $_REQUEST["s"])));
	...
	// ========================================================================
		$n_LocusID = str_replace("_"," ",strtoupper(trim(mysqli_real_escape_string($whConn, $_REQUEST["lid"]))));
	...
	// ========================================================================
		$n_PilotID 		= trim(mysqli_real_escape_string($whConn, $_REQUEST["id"]));
	...
	// ========================================================================
		$n_CorpID 		= trim(mysqli_real_escape_string($whConn, $_REQUEST["id"]));
	...
	// ========================================================================
		$n_AllianceID 	= trim(mysqli_real_escape_string($whConn, $_REQUEST["id"]));
	...
	// ========================================================================
		$n_ID			= trim(mysqli_real_escape_string($whConn, $_REQUEST["id"]));
	...
	// ========================================================================
		$n_ImageURL 	= trim(mysqli_real_escape_string($whConn, $_REQUEST["url"]));
